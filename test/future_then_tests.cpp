...
BOOST_AUTO_TEST_CASE(future_void_single_task_detached) {
    ...
    atomic_int p{0};
    {
        auto detached = async([& _p = p] { _p = 42; } & custom_scheduler_0);
        detached.detach();
    }
    while (p.load() != 42) {
    }
...
BOOST_AUTO_TEST_CASE(future_void_two_tasks_with_same_scheduler_then_on_rvalue) {
...

    {
        ...
        sut = async([] { return 42; } & custom_scheduler_0) |
              ([& _p = p](auto p) { _p = p; } & default_executor);
...
BOOST_AUTO_TEST_CASE(future_void_two_tasks_with_same_scheduler_then_on_lvalue) {
    ...
    atomic_int p{0};
    auto interim = async([& _p = p] { _p = 42; } & custom_scheduler_0);
...
BOOST_AUTO_TEST_CASE(future_int_void_two_tasks_with_same_scheduler) {
    ...
    sut = async([] { return 42; } & custom_scheduler_0) | [& _p = p](auto x) { _p = x + 42; };
    check_valid_future(sut);
...
BOOST_AUTO_TEST_CASE(future_int_void_two_tasks_with_different_scheduler) {
    ...
    sut = async([] { return 42; } & custom_scheduler_0) |
          ([& _p = p](auto x) { _p = x + 42; } & custom_scheduler_1);
...
BOOST_AUTO_TEST_CASE(reduction_future_void) {
    ...
    sut = async([&] { first = true; } & custom_scheduler_0) |
          [&] { return async([&] { second = true; } & custom_scheduler_0); };
...
BOOST_AUTO_TEST_CASE(future_non_copyable_single_task) {
    ...
    sut = async([] { return move_only(42); } & custom_scheduler_0);
...
BOOST_AUTO_TEST_CASE(future_non_copyable_capture) {
    ...
    sut = async([& _m = m] { return move_only(_m.member()); } & custom_scheduler_0);
...
BOOST_AUTO_TEST_CASE(
    ...
    sut = async([] { return 42; } & custom_scheduler_0) | [](auto x) { return move_only(x); };
...
BOOST_AUTO_TEST_CASE(
    ...
    sut = async([] { return 42; } & custom_scheduler_0) |
          ([](auto x) { return move_only(x); } & custom_scheduler_1);
...
BOOST_AUTO_TEST_CASE(
    ...
    auto interim = async([] { return 42; } & custom_scheduler_0);
...
BOOST_AUTO_TEST_CASE(
    ...
    sut = interim | ([](auto x) { return move_only(x); } & custom_scheduler_1);
...
BOOST_AUTO_TEST_CASE(future_non_copyable_as_continuation_with_different_scheduler_then_on_rvalue) {
    ...
    sut = async([] { return move_only(42); } & custom_scheduler_0) |
          ([](auto x) { return move_only(x.member() * 2); } & custom_scheduler_1);
...
BOOST_AUTO_TEST_CASE(future_async_move_only_move_captured_to_result) {
    ...
    sut = async([] { return move_only{42}; } & custom_scheduler_0) | [](auto x) { return move(x); };
...
BOOST_AUTO_TEST_CASE(future_async_moving_move_only_capture_to_result) {
    ...
    sut = async([& _m = m] { return move(_m); } & custom_scheduler_0);
...
BOOST_AUTO_TEST_CASE(future_continuation_moving_move_only_capture_to_result) {
    ...
    sut = async([] { return move_only{10}; } & custom_scheduler_0) |
...
BOOST_AUTO_TEST_CASE(future_int_two_tasks_with_same_scheduler_then_on_rvalue) {
    ...
    sut = async([] { return 42; } & custom_scheduler_0) | [](auto x) { return x + 42; };
...
BOOST_AUTO_TEST_CASE(future_int_two_tasks_with_different_scheduler) {
    ...
    sut = async([] { return 42; } & custom_scheduler_0) |
          ([](auto x) { return x + 42; } & custom_scheduler_1);
...
BOOST_AUTO_TEST_CASE(future_void_int_two_tasks_with_same_scheduler) {
    ...
    sut = async([& _p = p] { _p = 42; } & custom_scheduler_0) | [& _p = p] {
        _p += 42;
        return _p.load();
    };
...
BOOST_AUTO_TEST_CASE(future_void_single_task_error) {
    ...
    sut = async([] { throw test_exception("failure"); } & custom_scheduler_0);
...
BOOST_AUTO_TEST_CASE(future_int_single_task_error) {
    ...
    sut = async([]() -> int { throw test_exception("failure"); } & custom_scheduler_0);
    wait_until_future_fails<test_exception>(sut);
...
BOOST_AUTO_TEST_CASE(future_int_two_tasks_error_in_1st_task_with_same_scheduler) {
    ...
    sut =
        async([] { throw test_exception("failure"); } & custom_scheduler_0) | [& _p = p]() -> int {
        _p = 42;
        return _p;
    };
...
BOOST_AUTO_TEST_CASE(future_int_Y_formation_tasks_where_one_of_the_2nd_task_failing) {
    ...
    sut = async([]() -> int { return 42; } & custom_scheduler_0);
    auto f1 = sut | ([](auto) -> int { throw test_exception("failure"); } & custom_scheduler_0);
    auto f2 = sut | ([](auto x) -> int { return x + 4711; } & custom_scheduler_0);
...
BOOST_AUTO_TEST_CASE(future_int_Y_formation_tasks_where_both_of_the_2nd_task_failing) {
    ...
    sut = async([]() -> int { return 42; } & custom_scheduler_0);
    auto f1 = sut | ([](auto) -> int { throw test_exception("failure1"); } & custom_scheduler_0);
    auto f2 = sut | ([](auto) -> int { throw test_exception("failure2"); } & custom_scheduler_0);
...
BOOST_AUTO_TEST_CASE(reduction_future_void_to_int_error) {
    ...
    sut = async([& _flag = first] { _flag = true; }) | ([& _flag = second]() -> future<int> {
              (void)_flag;
              throw test_exception("failure");
          } & default_executor);
