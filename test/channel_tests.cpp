...
BOOST_AUTO_TEST_CASE(int_channel_concatenate_with_different_executor) {
    BOOST_TEST_MESSAGE("int channel concatenate with different executor");
    ...
    auto check = receive | ( [&](int x) { result += x; } & executor{immediate_executor} );
