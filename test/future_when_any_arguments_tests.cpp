...
BOOST_AUTO_TEST_CASE(future_when_any_int_void_range_with_one_argument) {
    ...
    size_t index = 4711;
    size_t result = 0;
    auto a1 = async([] { return 42; } & custom_scheduler_0);
...
BOOST_AUTO_TEST_CASE(future_when_any_int_void_range_with_many_arguments_first_succeeds) {
    ...
    auto a1 = async(make_non_blocking_functor(
                        ...
                        _task_counter) &
                    custom_scheduler_0);
    auto a2 = async(make_blocking_functor([] { return 2; }, _task_counter, block_context) &
                    custom_scheduler_0);
    auto a3 = async(make_blocking_functor([] { return 3; }, _task_counter, block_context) &
                    custom_scheduler_0);
    auto a4 = async(make_blocking_functor([] { return 5; }, _task_counter, block_context) &
                    custom_scheduler_0);
    {
...
BOOST_AUTO_TEST_CASE(future_when_any_int_void_argument_with_many_arguments_middle_succeeds) {
    ...
    auto a1 = async(make_blocking_functor([] { return 1; }, _task_counter, block_context) &
                    custom_scheduler_0);
    auto a2 = async(make_blocking_functor([] { return 2; }, _task_counter, block_context) &
                    custom_scheduler_0);
...
BOOST_AUTO_TEST_CASE(
    ...
    auto a1 = async(make_failing_functor([] { return 1; }, _task_counter) & custom_scheduler_0);
    auto a2 = async(make_failing_functor([] { return 1; }, _task_counter) & custom_scheduler_0);
    auto a3 =
        async(make_non_blocking_functor([] { return 3; }, _task_counter) & custom_scheduler_0);
    auto a4 = async(make_failing_functor([] { return 1; }, _task_counter) & custom_scheduler_0);
...
BOOST_AUTO_TEST_CASE(future_when_any_int_void_arguments_with_many_arguments_all_fail) {
    ...
    auto a1 = async(make_failing_functor([] { return 0; }, _task_counter) & custom_scheduler_0);
    auto a2 = async(make_failing_functor([] { return 0; }, _task_counter) & custom_scheduler_0);
    auto a3 = async(make_failing_functor([] { return 0; }, _task_counter) & custom_scheduler_0);
    auto a4 = async(make_failing_functor([] { return 0; }, _task_counter) & custom_scheduler_0);
...
BOOST_AUTO_TEST_CASE(future_when_any_int_int_argument_with_one_argument) {
    ...
    auto a1 = async([] { return 4711; } & custom_scheduler_0);
...
BOOST_AUTO_TEST_CASE(future_when_any_int_int_arguments_with_many_arguments_last_succeeds) {
    ...
    auto a1 = async(make_blocking_functor([] { return 42; }, _task_counter, block_context) &
                    custom_scheduler_0);
    auto a2 = async(make_blocking_functor([] { return 815; }, _task_counter, block_context) &
                    custom_scheduler_0);
    auto a3 = async(make_blocking_functor([] { return 4711; }, _task_counter, block_context) &
                    custom_scheduler_0);
    auto a4 = async(make_non_blocking_functor(
                        [& _context = block_context] {
                            _context._may_proceed = true;
...
BOOST_AUTO_TEST_CASE(
    ...
    auto a2 = async(make_failing_functor(
                        ...
                        _task_counter) &
                    custom_scheduler_0);
    auto a3 = async(make_non_blocking_functor([]() -> int { return 3; }, _task_counter) &
                    custom_scheduler_0);
...
BOOST_AUTO_TEST_CASE(future_when_any_int_arguments_with_diamond_formation_arguments) {
    ...
    size_t index = 0;
    {
        ...
        auto a1 = start | (make_blocking_functor([](int x) { return x + 1; }, _task_counter,
                                                 block_context) &
                           custom_scheduler_0);
        auto a2 = start | (make_non_blocking_functor(
                               ...
                               _task_counter) &
                           custom_scheduler_0);
        auto a3 = start | (make_blocking_functor([](int x) { return x + 3; }, _task_counter,
                                                 block_context) &
                           custom_scheduler_0);
        auto a4 = start | (make_blocking_functor([](int x) { return x + 5; }, _task_counter,
                                                 block_context) &
                           custom_scheduler_0);
...
BOOST_AUTO_TEST_CASE(future_when_any_move_only_argument_with_one_argument) {
    ...
    auto a1 = async([] { return move_only(4711); } & custom_scheduler_0);
