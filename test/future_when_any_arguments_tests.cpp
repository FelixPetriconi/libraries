...
BOOST_AUTO_TEST_CASE(future_when_any_int_void_range_with_one_argument) {
    ...
    size_t index = 4711;
    size_t result = 0;
    auto a1 = async([] { return 42; } & make_executor<0>());

    sut = when_any([& _i = index, &_r = result](int x, size_t index) {
                       _i = index;
                       _r = x;
                   } & make_executor<1>(),
                   a1);
...
BOOST_AUTO_TEST_CASE(future_when_any_int_void_range_with_many_arguments_first_succeeds) {
    ...
    auto a1 = async(make_non_blocking_functor([& _context = block_context]() {
                                                   _context._may_proceed = true;
                                                   return 1;
                                               },
                                               _task_counter) & make_executor<0>());
    auto a2 = async(make_blocking_functor([] { return 2; }, _task_counter, block_context) & make_executor<0>());
    auto a3 = async(make_blocking_functor([] { return 3; }, _task_counter, block_context) & make_executor<0>());
    auto a4 = async(make_blocking_functor([] { return 5; }, _task_counter, block_context) & make_executor<0>());
    {
        lock_t block(*block_context._mutex);

        sut = when_any([& _r = result, &_used_future_index = used_future_index,
...
BOOST_AUTO_TEST_CASE(future_when_any_int_void_argument_with_many_arguments_middle_succeeds) {
    ...
    auto a1 = async(make_blocking_functor([] { return 1; }, _task_counter, block_context) & make_executor<0>());
    auto a2 = async(make_blocking_functor([] { return 2; }, _task_counter, block_context) & make_executor<0>());
    auto a3 = async(make_non_blocking_functor(
...
BOOST_AUTO_TEST_CASE(future_when_any_int_void_argument_with_many_arguments_last_succeeds) {
    ...
    auto a2 = async(make_blocking_functor([] { return 2; }, _task_counter, block_context) & make_executor<0>());
    auto a3 = async(make_blocking_functor([] { return 3; }, _task_counter, block_context) & make_executor<0>());
    auto a4 = async(make_non_blocking_functor(
                                               [& _context = block_context] {
                                                   _context._may_proceed = true;
                                                   return 5;
                                               },
...
BOOST_AUTO_TEST_CASE(
    ...
    auto a1 = async(make_failing_functor([] { return 1; }, _task_counter) & make_executor<0>());
    auto a2 = async(make_failing_functor([] { return 1; }, _task_counter) & make_executor<0>());
    auto a3 =
        async(make_non_blocking_functor([] { return 3; }, _task_counter) & make_executor<0>());
    auto a4 = async(make_failing_functor([] { return 1; }, _task_counter) & make_executor<0>());

    sut = when_any([& _i = index, &_result = result,
                    &_counter = any_task_execution_counter](int x, size_t index) {
                       ++_counter;
                       _i = index;
                       _result = x;
...
BOOST_AUTO_TEST_CASE(future_when_any_int_void_arguments_with_many_arguments_all_fail) {
    ...
    auto a1 = async(make_failing_functor([] { return 0; }, _task_counter) & make_executor<0>());
    auto a2 = async(make_failing_functor([] { return 0; }, _task_counter) & make_executor<0>());
    auto a3 = async(make_failing_functor([] { return 0; }, _task_counter) & make_executor<0>());
    auto a4 = async(make_failing_functor([] { return 0; }, _task_counter) & make_executor<0>());

    sut = when_any([& _i = index, &_r = r](int x, size_t index) {
                       _i = index;
                       _r = x;
                   } & make_executor<1>(),
                   a1, a2, a3, a4);
...
BOOST_AUTO_TEST_CASE(future_when_any_int_int_argument_with_one_argument) {
    ...
    auto a1 = async([] { return 4711; } & make_executor<0>());
...
BOOST_AUTO_TEST_CASE(future_when_any_int_int_arguments_with_many_arguments_last_succeeds) {
    ...
    auto a1 = async(make_blocking_functor([] { return 42; }, _task_counter, block_context) & make_executor<0>());
    auto a2 = async(make_blocking_functor([] { return 815; }, _task_counter, block_context) & make_executor<0>());
    auto a3 = async(make_blocking_functor([] { return 4711; }, _task_counter, block_context) & make_executor<0>());
    auto a4 = async(make_non_blocking_functor(
                                               [& _context = block_context] {
                                                   _context._may_proceed = true;
                                                   return 5;
    ...
    {
        lock_t lock(*block_context._mutex);
        sut = when_any([& _used_future_index = used_future_index,
                        &_counter = any_task_execution_counter](int x, size_t index) {
                           _used_future_index = index;
                           ++_counter;
                           return x;
...
BOOST_AUTO_TEST_CASE(
    ...
    auto a1 = async(make_failing_functor(
                                               [& _f = failures]() -> int {
                                                   ++_f;
                                                   return 0;
                                               },
                                               _task_counter) & make_executor<0>());
    auto a2 = async(make_failing_functor(
                                               [& _f = failures]() -> int {
                                                   ++_f;
                                                   return 0;
                                               },
                                               _task_counter) & make_executor<0>());
    auto a3 = async(make_non_blocking_functor([]() -> int { return 3; }, _task_counter) & make_executor<0>());
    auto a4 = async(make_failing_functor(
                                               [& _f = failures]() -> int {
                                                   ++_f;
                                                   return 0;
                                               },
    ...
    sut = when_any([& _index = index](int x, size_t index) {
                       _index = index;
                       return x;
                   } & make_executor<1>(),
                   a1, a2, a3, a4);
...
BOOST_AUTO_TEST_CASE(future_when_any_move_only_argument_with_one_argument) {
  ...
  auto a1 = async([] { return move_only(4711); } & make_executor<0>());

  sut = when_any([&_i = index](move_only(x), size_t index) {
    _i = index;
    return x;
  } & make_executor<1>(),
    std::move(a1));
