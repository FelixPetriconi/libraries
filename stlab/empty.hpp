...
template <>
struct is_pod<stlab::version_1::empty_t> : boost::mpl::true_ {};
template <>
struct is_empty<stlab::version_1::empty_t> : boost::mpl::true_ {};
template <>
struct has_trivial_constructor<stlab::version_1::empty_t> : boost::mpl::true_ {};
template <>
struct has_trivial_destructor<stlab::version_1::empty_t> : boost::mpl::true_ {};
}
